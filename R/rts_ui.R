...
rts2_ui <- function(){
  shiny::fluidPage(
    ...
    shiny::sidebarLayout(
      shiny::sidebarPanel(
        shiny::numericInput("rts2_N",
                            "Plot capacity:",
                            min = 100,
                            max = 10000,
                            step = 100,
                            value = 1000),
        shiny::numericInput("rts2_k",
                            "Number of locations:",
                            min = 1,
                            max = 100,
                            step = 1,
                            value = 3),
        shiny::numericInput("rts2_q",
                            "Number of years:",
                            min = 1,
                            max = 100,
                            step = 1,
                            value = 3),
        shiny::numericInput("rts2_sg1",
                            "Number of selected genotypes:",
                            min = 1,
                            max = 10000,
                            step = 10,
                            value = 10),
        shiny::numericInput("rts2_sigmaG2",
                            "Genotypic variance:",
                            min = 0.01,
                            max = 1000,
                            step = 0.1,
                            value = 1),
        shiny::numericInput("rts2_sigmaGL2",
                            "Genotypic x location variance:",
                            min = 0.01,
                            max = 1000,
                            step = 0.1,
                            value = 1),
        shiny::numericInput("rts2_sigmaE2",
                            "Error variance:",
                            min = 0.01,
                            max = 1000,
                            step = 0.1,
...
rts3_ui <- function(){
  ...
  shiny::sidebarLayout(
    shiny::sidebarPanel(
      shiny::numericInput("rts3_N",
                          "Plot capacity:",
                          min = 100,
                          max = 10000,
                          step = 100,
                          value = 1000),
      shiny::numericInput("rts3_k",
                          "Number of locations:",
                          min = 1,
                          max = 100,
                          step = 1,
                          value = 3),
      shiny::numericInput("rts3_q",
                          "Number of years:",
                          min = 1,
                          max = 100,
                          step = 1,
                          value = 3),
      shiny::numericInput("rts3_sg1",
                          "Number of selected genotypes:",
                          min = 0,
                          max = 10000,
                          step = 10,
                          value = 10),
      shiny::numericInput("rts3_sigmaG2",
                          "Genotypic variance:",
                          min = 0,
                          max = 1000,
                          step = 0.1,
                          value = 1),
      shiny::numericInput("rts3_sigmaGL2",
                          "Genotypic x location variance:",
                          min = 0,
                          max = 1000,
                          step = 0.1,
                          value = 1),
      shiny::numericInput("rts3_sigmaGY2",
                          "Genotypic x year variance:",
                          min = 0,
                          max = 1000,
                          step = 0.1,
                          value = 1),
      shiny::numericInput("rts3_sigmaGLY2",
                          "Genotypic x location x year variance:",
                          min = 0,
                          max = 1000,
                          step = 0.1,
                          value = 1),
      shiny::numericInput("rts3_sigmaE2",
                          "Error variance:",
                          min = 0,
                          max = 1000,
                          step = 0.1,
